            ...
            return (
                ...
                (n._slide = function(t, n) {
                    ...
                    if (
                        ...
                        this._isSliding = !1;
                    else if (!this._triggerSlideEvent(h, s).isDefaultPrevented() &&
                        a &&
                        h
                    ) {
                        (this._isSliding = !0),
            ...
            return (
                ...
                (i._setListeners = function() {
                    ...
                    this.config.trigger.split(" ").forEach(function(n) {
                        ...
                        (this.config = a(
                            a({}, this.config), {}, { trigger: "manual", selector: "" }
                        )) :
                        this._fixTitle();
                }),
            ...
            return (
                (n.show = function() {
                    ...
                    if (!(
                        ...
                        if (
                            (i && e(i).trigger(a),
                                e(this._element).trigger(l), !l.isDefaultPrevented() && !a.isDefaultPrevented())
                        ) {
