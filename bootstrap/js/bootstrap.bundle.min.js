...
!(function(t, e) {
                    ...
                    this._element.hasAttribute("disabled") ||
                        ...
                        (n &&
                            this._element.setAttribute(
                                "aria-pressed", !this._element.classList.contains("active")
                            ),
    ...
    e(document)
        .on("click.bs.button.data-api", '[data-toggle^="button"]', function(t) {
            var n = t.target,
                i = n;
            if (
                (e(n).hasClass("btn") || (n = e(n).closest(".btn")[0]), !n || n.hasAttribute("disabled") || n.classList.contains("disabled"))
            )
                t.preventDefault();
            else {
            ...
            return (
                ...
                (n._slide = function(t, n) {
                    ...
                    if (
                        ...
                        this._isSliding = !1;
                    else if (!this._triggerSlideEvent(u, r).isDefaultPrevented() &&
                        a &&
                        u
                    ) {
                        (this._isSliding = !0),
    ...
    function R(t) {
        ...
        for (
            var e = F(10) ? document.body : null, n = t.offsetParent || null; n === e && t.nextElementSibling;
                ...
                (t._dataApiKeydownHandler = function(n) {
                    if (!(/input|textarea/i.test(n.target.tagName) ?
                        ...
                        if (o || 27 !== n.which) {
                            if (
                                (n.preventDefault(),
                                    n.stopPropagation(), !o || (o && (27 === n.which || 32 === n.which)))
                            )
                                return (
                                    27 === n.which &&
            ...
            return (
                ...
                (n._setListeners = function() {
                    ...
                    this.config.trigger.split(" ").forEach(function(n) {
                        ...
                        (this.config = s(
                            s({}, this.config), {}, { trigger: "manual", selector: "" }
                        )) :
                        this._fixTitle();
                }),
                ...
                (n._leave = function(t, n) {
                    ...
                    ((n = new this.constructor(
                        ...
                        e(t.currentTarget).data(i, n)),
                    t &&
                        (n._activeTrigger["focusout" === t.type ? "focus" : "hover"] = !1),
            ...
            return (
                (n.show = function() {
                    ...
                    if (!(
                        ...
                        if (
                            (i && e(i).trigger(a),
                                e(this._element).trigger(c), !c.isDefaultPrevented() && !a.isDefaultPrevented())
                        ) {
